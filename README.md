...
2. У вложенных тестов не должно быть своих предусловий и постусловий - они могут быть только внутри контейнера. В противном случае эти предусловия/постусловия одновременно запишутся как в отдельный тест, так и в контейнер. Если необходимо использовать для определённого теста уникальные предусловия и/или постусловия, то нужно вынести такой тест за рамки контейнера;  
