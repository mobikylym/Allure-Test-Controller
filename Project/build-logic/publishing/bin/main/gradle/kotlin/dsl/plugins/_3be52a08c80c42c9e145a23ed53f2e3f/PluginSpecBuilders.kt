...
package gradle.kotlin.dsl.plugins._3be52a08c80c42c9e145a23ed53f2e3f
...
/**
 * The `com.github.autostyle` plugin implemented by [com.github.autostyle.gradle.AutostylePlugin].
 */
internal
val `ComGithubPluginGroup`.`autostyle`: PluginDependencySpec
    get() = plugins.id("com.github.autostyle")
...
/**
 * The `com.github.vlsi` plugin group.
 */
@org.gradle.api.Generated
internal
class `ComGithubVlsiPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `com.github.vlsi`.
 */
internal
val `ComGithubPluginGroup`.`vlsi`: `ComGithubVlsiPluginGroup`
    get() = `ComGithubVlsiPluginGroup`(plugins)


/**
 * The `com.github.vlsi.crlf` plugin implemented by [com.github.vlsi.gradle.crlf.CrlfPlugin].
 */
internal
val `ComGithubVlsiPluginGroup`.`crlf`: PluginDependencySpec
    get() = plugins.id("com.github.vlsi.crlf")


/**
 * The `com.github.vlsi.gradle-extensions` plugin implemented by [com.github.vlsi.gradle.ProjectExtensionsPlugin].
 */
internal
val `ComGithubVlsiPluginGroup`.`gradle-extensions`: PluginDependencySpec
    get() = plugins.id("com.github.vlsi.gradle-extensions")


/**
 * The `com.github.vlsi.ide` plugin implemented by [com.github.vlsi.gradle.ide.IdePlugin].
 */
internal
val `ComGithubVlsiPluginGroup`.`ide`: PluginDependencySpec
    get() = plugins.id("com.github.vlsi.ide")
...
/**
 * The `de.thetaphi` plugin group.
 */
@org.gradle.api.Generated
internal
class `DeThetaphiPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `de.thetaphi`.
 */
internal
val `DePluginGroup`.`thetaphi`: `DeThetaphiPluginGroup`
    get() = `DeThetaphiPluginGroup`(plugins)


/**
 * The `de.thetaphi.forbiddenapis` plugin implemented by [de.thetaphi.forbiddenapis.gradle.ForbiddenApisPlugin].
 */
internal
val `DeThetaphiPluginGroup`.`forbiddenapis`: PluginDependencySpec
    get() = plugins.id("de.thetaphi.forbiddenapis")
...
@org.gradle.api.Generated
internal
class `MePluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `me`.
 */
internal
val `PluginDependenciesSpec`.`me`: `MePluginGroup`
    get() = `MePluginGroup`(this)


/**
 * The `me.champeau` plugin group.
 */
@org.gradle.api.Generated
internal
class `MeChampeauPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `me.champeau`.
 */
internal
val `MePluginGroup`.`champeau`: `MeChampeauPluginGroup`
    get() = `MeChampeauPluginGroup`(plugins)


/**
 * The `me.champeau.gradle` plugin group.
 */
@org.gradle.api.Generated
internal
class `MeChampeauGradlePluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `me.champeau.gradle`.
 */
internal
val `MeChampeauPluginGroup`.`gradle`: `MeChampeauGradlePluginGroup`
    get() = `MeChampeauGradlePluginGroup`(plugins)


/**
 * The `me.champeau.gradle.jmh` plugin implemented by [me.champeau.jmh.JmhPlugin].
 */
internal
val `MeChampeauGradlePluginGroup`.`jmh`: PluginDependencySpec
    get() = plugins.id("me.champeau.gradle.jmh")


/**
 * The `me.champeau.jmh` plugin implemented by [me.champeau.jmh.JMHPlugin].
 */
internal
val `MeChampeauPluginGroup`.`jmh`: PluginDependencySpec
    get() = plugins.id("me.champeau.jmh")
...
/**
 * The `org.checkerframework` plugin implemented by [org.checkerframework.gradle.plugin.CheckerFrameworkPlugin].
 */
internal
val `OrgPluginGroup`.`checkerframework`: PluginDependencySpec
    get() = plugins.id("org.checkerframework")
...
/**
 * The `org.sonarqube` plugin implemented by [org.sonarqube.gradle.SonarQubePlugin].
 */
internal
val `OrgPluginGroup`.`sonarqube`: PluginDependencySpec
    get() = plugins.id("org.sonarqube")
