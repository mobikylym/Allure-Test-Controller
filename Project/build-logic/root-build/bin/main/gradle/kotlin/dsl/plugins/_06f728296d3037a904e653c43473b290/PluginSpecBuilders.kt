...
package gradle.kotlin.dsl.plugins._06f728296d3037a904e653c43473b290
...
/**
 * The `org.nosphere` plugin group.
 */
@org.gradle.api.Generated
internal
class `OrgNospherePluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `org.nosphere`.
 */
internal
val `OrgPluginGroup`.`nosphere`: `OrgNospherePluginGroup`
    get() = `OrgNospherePluginGroup`(plugins)


/**
 * The `org.nosphere.apache` plugin group.
 */
@org.gradle.api.Generated
internal
class `OrgNosphereApachePluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `org.nosphere.apache`.
 */
internal
val `OrgNospherePluginGroup`.`apache`: `OrgNosphereApachePluginGroup`
    get() = `OrgNosphereApachePluginGroup`(plugins)


/**
 * The `org.nosphere.apache.rat` plugin implemented by [org.nosphere.apache.RatPlugin].
 */
internal
val `OrgNosphereApachePluginGroup`.`rat`: PluginDependencySpec
    get() = plugins.id("org.nosphere.apache.rat")


/**
 * The `org.nosphere.apache.rat-base` plugin implemented by [org.nosphere.apache.RatBasePlugin].
 */
internal
val `OrgNosphereApachePluginGroup`.`rat-base`: PluginDependencySpec
    get() = plugins.id("org.nosphere.apache.rat-base")
