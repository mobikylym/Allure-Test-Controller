...
package gradle.kotlin.dsl.plugins._189ea58c3610e1ec526b7486e2370b36
...
/**
 * The `org.gradle.kotlin` plugin group.
 */
@org.gradle.api.Generated
internal
class `OrgGradleKotlinPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `org.gradle.kotlin`.
 */
internal
val `OrgGradlePluginGroup`.`kotlin`: `OrgGradleKotlinPluginGroup`
    get() = `OrgGradleKotlinPluginGroup`(plugins)


/**
 * The `org.gradle.kotlin.embedded-kotlin` plugin implemented by [org.gradle.kotlin.dsl.plugins.embedded.EmbeddedKotlinPlugin].
 */
internal
val `OrgGradleKotlinPluginGroup`.`embedded-kotlin`: PluginDependencySpec
    get() = plugins.id("org.gradle.kotlin.embedded-kotlin")


/**
 * The `org.gradle.kotlin.kotlin-dsl` plugin implemented by [org.gradle.kotlin.dsl.plugins.dsl.KotlinDslPlugin].
 */
internal
val `OrgGradleKotlinPluginGroup`.`kotlin-dsl`: PluginDependencySpec
    get() = plugins.id("org.gradle.kotlin.kotlin-dsl")
