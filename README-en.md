...
2. Nested tests should not have their own preconditions and postconditions - they can only be inside the container. Otherwise, these preconditions/postconditions will be recorded both as a separate test and in the container. If it is necessary to use unique preconditions and/or postconditions for a specific test, such a test should be taken out of the container;  
